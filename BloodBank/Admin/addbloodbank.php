   ...
   <body onload='loadStates()'>
            ...
            <div style="width:800px;float:left">
               ...
               <form method="post" enctype="multipart/form-data">
                  <table border="0" align="center" width="400" height="300px" class="shaddoww">
                     <tr>
                        <td colspan="2" align="center" class="toptd">Add BloodBank </td>
                     </tr>
                     <tr>
                        <td colspan="2">&nbsp;</td>
                     </tr>
      ...
      <?php
        	if (isset($_POST["sbmt"])){
					...
					$sql = "insert into bloodbank(name,type,state,district,address) values('" . $_POST["name"] ."','" . $_POST["type"] . "'," . $_POST["state"] . "," . $_POST["district"] . ",'" . $_POST["address"]  ."')";"";
				
					if($conn->query($sql))
					echo '<script>alert("Blood Bank added!")</script>';
					else
