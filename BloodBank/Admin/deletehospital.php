...
<tr><td colspan="2" align="center" class="toptd">Delete hospital</td></tr>

<tr><td colspan="2">&nbsp;</td></tr>
<tr><td class="lefttd">Select hospital </td><td><select name="s1" required><option value="">Select</option>
...
if (isset($_POST["sbmt"])){
                ...
                $sql = "delete from hospital where id=".$_POST['s1']."";
