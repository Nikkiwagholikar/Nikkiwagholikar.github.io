...
{
	$cn=makeconnection();
	$s="update bloodbank set bloodname ='" .$_POST["t2"] ."' where bid='" . $_POST["s2"] ."'";
	mysqli_query($cn,$s);
	mysqli_close($cn);
...
<tr><td colspan="2" align="center" class="toptd">Update Blood Bank</td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td class="lefttd">Select Blood bank </td><td><select name="s2" required><option value="">Select</option>
...
{
$cn=makeconnection();
$s="select * from bloodbank where bid='" .$_POST["s2"] ."'";
	$result=mysqli_query($cn,$s);
	$r=mysqli_num_rows($result);
	//echo $r;
