	...
	<body onload='loadStates()'>
        ...
        <form method="post" enctype="multipart/form-data">
                  <table border="0" align="center" width="400" height="300px" class="shaddoww">
                     <tr>
                        <td colspan="2" align="center" class="toptd">Update BloodBank </td>
                     </tr>
                     <tr>
                        <td colspan="2">&nbsp;</td>
                     </tr>
                     <tr>
							...
							<tr>
								<td class="lefttd">Select bloodbank </td>
								<td>
									<select name="bloodbank" required>
										...
										<?php
											...
											$s="select * from bloodbank";
												...
												{
													if(isset($_POST["show"])&& $data[0]==$_POST["bloodbank"])
													{
									...
									<?php
										...
										{
										$cn=makeconnection();
										$s="select * from bloodbank where id='" .$_POST["bloodbank"] ."'";
											$result=mysqli_query($cn,$s);
											$r=mysqli_num_rows($result);
											//echo $r;
                     ...
                     <tr>
                        ...
                        <td><input type="text" name="type" value="<?php if(isset($_POST["show"])){echo $type;} ?>" required="required" /></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        ...
                        <td><input type="text" name="address" value="<?php if(isset($_POST["show"])){echo $address;} ?>" ></td>
                     </tr>
                     <tr>
                        <td>&nbsp;</td>
		...
		if (isset($_POST["sbmt"])){
                ...
                $sql = "UPDATE bloodbank 
                        SET    NAME      ='".$_POST['name']."',
                                type    ='".$_POST['type']."',
                                state   =".$_POST['state'].",
                                district=".$_POST['district'].",
                                address='".$_POST['address']."'
                        WHERE  id       =".$_POST["bloodbank"]; 
