	...
	<body onload='loadStates()'>
        ...
        <form method="post" enctype="multipart/form-data">
                  <table border="0" align="center" width="400" height="300px" class="shaddoww">
                     <tr>
                        <td colspan="2" align="center" class="toptd">Update hospital </td>
                     </tr>
                     <tr>
                        <td colspan="2">&nbsp;</td>
                     </tr>
                     <tr>
							...
							<tr>
								<td class="lefttd">Select hospital </td>
								<td>
									<select name="hospital" required>
										...
										<?php
											...
											$s="select * from hospital";
												...
												{
													if(isset($_POST["show"])&& $data[0]==$_POST["hospital"])
													{
									...
									<?php
										...
										{
										$cn=makeconnection();
										$s="select * from hospital where id='" .$_POST["hospital"] ."'";
											$result=mysqli_query($cn,$s);
											$r=mysqli_num_rows($result);
											//echo $r;
