...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <!-- <div style="height:300px; width:1000px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;"> -->
            ...
            <div class="p1" style="text-align: center;font-size: 40px; margin-top: 40px; margin-bottom:30px ;color: Maroon;  font-family: 'Times New Roman', Times, serif;">Requests for your bloodgroup</div>
                ...
                <table cellpadding="20" cellspacing="20" width="1300px"  style="margin:auto">
                    ...
                    <?php
                        error_reporting(0);
                        $cn = makeconnection();
                        $s ="SELECT BLOODGROUP FROM DONOR WHERE EMAIL='".$_SESSION["email"]."'" ;
                                    
                        $result = mysqli_query($cn, $s);
                        $data = mysqli_fetch_array($result);
                        $donorbloodgroup=$data[0];
